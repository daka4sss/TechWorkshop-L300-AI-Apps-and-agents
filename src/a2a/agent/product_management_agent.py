    ...
    def __init__(self):
        ...
        marketing_agent = Agent(
            ...
            instructions=(
                ...
                'and suggesting promotional tactics. '
                'Your goal is to help businesses effectively market their products '
                'and reach their desired customers.'
            ),
        )
        ...
        product_agent = Agent(
            ...
            instructions=(
                ...
                "Do not ask the user for more information about the products; instead use the get_products tool "
                "to find the relevant products and provide the information based on that. "
        ...
        self.agent = Agent(
            ...
            instructions=(
                ...
                "Your primary goal is precise and efficient delegation to ensure customers and employees "
                "receive accurate and specialized assistance promptly. "
